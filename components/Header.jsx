    ...
    <Navbar isBordered variant="sticky">
      ...
      <Navbar.Content>
        <Navbar.Item hideIn="xs">
          <div className="nextui-c-dfbgCO nextui-c-dfbgCO-fGHEql-fluid-true nextui-c-dfbgCO-iixtXjF-css navbar__social-icons-container">
            <a className="nextui-c-dIWzTP nextui-c-PJLV nextui-c-dIWzTP-hfnKRU-color-default nextui-c-dIWzTP-isWIbj-animated-true nextui-c-PJLV-gulvcB-isFocusVisible-false nextui-c-dIWzTP-ifEEqNe-css nextui-link navbar__social-icon" href="https://instagram.com/avaevolve" rel="noreferrer" target="_blank">
            ...
            <a className="nextui-c-dIWzTP nextui-c-PJLV nextui-c-dIWzTP-hfnKRU-color-default nextui-c-dIWzTP-isWIbj-animated-true nextui-c-PJLV-gulvcB-isFocusVisible-false nextui-c-dIWzTP-ifEEqNe-css nextui-link navbar__social-icon" href="https://discord.gg/Yg3dVzaDqp" rel="noreferrer" target="_blank">
            ...
            </a><a className="nextui-c-dIWzTP nextui-c-PJLV nextui-c-dIWzTP-hfnKRU-color-default nextui-c-dIWzTP-isWIbj-animated-true nextui-c-PJLV-gulvcB-isFocusVisible-false nextui-c-dIWzTP-ifEEqNe-css nextui-link navbar__social-icon" href="https://github.com/one-loop/AVA" rel="noreferrer" target="_blank"><svg className="" height="24" viewBox="0 0 24 24" width="24">
        ...
        <Navbar.Item hideIn="xs">
          <Button auto flat as={Link} href="#" css={{ background: '#333333b3', color: '#ffffff', fontSize: '14px' }}>
            <svg fill="var(--nextui-colors-red600)" height="20" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg" className="nextui-c-PJLV">
